...
For full setup instructions, contribution guidelines, branch management strategies, and the fixed-file sync workflow, please refer to the [README](../README.md).
